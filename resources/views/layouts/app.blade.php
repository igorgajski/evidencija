...
<html lang="en">
  ...
  <body>
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <a class="navbar-brand" href="#">Evidencija informatičke opreme</a>
          ...
          More
                      ...
                      <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                          ...
                          <a class="dropdown-item" href="{{ route('device_types.index') }}">Device types</a>
                          <a class="dropdown-item" href="{{ route('manufacturers.index') }}">Manufacturers</a>
                          <a class="dropdown-item" href="{{ route('user_devices.index') }}">User Devices</a>
